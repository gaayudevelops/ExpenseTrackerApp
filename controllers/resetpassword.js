...
const forgotpassword = async (req, res) => {
    ...
    try {
        ...
        if(user){
            ...
            const msg = {
                to: email, 
                from: 'harigayathriv@gmail.com', 
                subject: 'Reset Password',
                html: `<a href="http://52.206.219.160:3000/password/resetpassword/${id}">Click here to reset the password</a>`
            }
    ...
    try {
        ...
        if(user) {
                ...
                res.status(200).send(`<html>
                                ...
                                <a href="http://52.206.219.160:3000/Login/login.html">Back to Login Page</a>
                            </html>`)
                res.end();
                });
        } else{
